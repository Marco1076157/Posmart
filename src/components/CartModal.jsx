                        ...
                        <>
                            {cartDetail.items.length === 0 ? (
                                ...
                                cartDetail.items.map((item) => (
                                    <div key={item.id} className="flex items-center gap-3 p-3 border border-slate-100 rounded-xl bg-slate-50/10 cursor-pointer">
                                        <img src={`${'api/products/'}${item.image}`} alt={item.name} className="w-16 h-16 object-cover rounded-lg bg-white border border-slate-100" />
                                        ...
                                        <div className="flex flex-col items-end justify-between self-stretch py-0.5">
                                            ...
                                            <button
                                                ...
                                                className="text-[11px] font-bold text-red-700 px-2 py-1 rounded-md cursor-pointer"
                                            >
                                                Hapus
                                            </button>
                                        </div>
