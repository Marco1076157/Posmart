        ...
        try {
            ...
            if (response.status >= 200 && response.status < 300) {
                ...
                if (response && response.data && response.data.status === 'success') {
                    ...
                    const totalQty = cartDetails.itemsReport.reduce((acc, item) => acc + Number(item.qty || 0), 0);
                    ...
                    localStorage.setItem('posmart_last_invoice', JSON.stringify(invoiceSnapshot));
                    
                    // Bersihkan keranjang belanja setelah sukses
                    //localStorage.removeItem('posmart_cart');
                    clearCart();
            ...
            <div className="space-y-1">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className={`w-full text-sm pl-10 pr-3 py-2 border rounded-lg focus:outline-hidden transition-colors ${
                            errors.fullName ? 'border-red-500 focus:border-red-500 bg-red-50/30' : 'border-slate-200 focus:border-red-500'
                        }`}
                    />
                </div>
            ...
            <div className="space-y-1">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className={`w-full text-sm pl-10 pr-3 py-2 border rounded-lg focus:outline-hidden transition-colors ${
                            errors.phone ? 'border-red-500 focus:border-red-500 bg-red-50/30' : 'border-slate-200 focus:border-red-500'
                        }`}
                    />
                </div>
            ...
            <div className="space-y-1">
                ...
                <div className="relative">
                    ...
                    <textarea
                        ...
                        className={`w-full text-sm pl-10 pr-3 py-2 border rounded-lg focus:outline-hidden transition-colors resize-none ${
                            errors.address ? 'border-red-500 focus:border-red-500 bg-red-50/30' : 'border-slate-200 focus:border-red-500'
                        }`}
                    />
                </div>
